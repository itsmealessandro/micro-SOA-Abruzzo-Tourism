...
public class RestaurantWithMenu {
  ...
  public String toString() {
    return "RestaurantWithMenu [id=" + id + ", name=" + name + ", location=" + location + ", rating=" + rating
        + ", specialties=" + specialties + ", cuisineType=" + cuisineType + ", menu=" + menu + ", getId()=" + getId()
        + ", getName()=" + getName() + ", getLocation()=" + getLocation() + ", getRating()=" + getRating()
        + ", getSpecialties()=" + getSpecialties() + ", getCuisineType()=" + getCuisineType() + ", getMenu()="
        + getMenu() + "]";
  }
  ...
  public RestaurantWithMenu(String id, String name, String location, double rating, List<String> specialties,
      CuisineType cuisineType, List<LocalDish> menu) {
    this.id = id;
    this.name = name;
  ...
  public List<LocalDish> getMenu() {
    return menu;
  }

  public void setMenu(List<LocalDish> menu) {
    this.menu = menu;
  }
}
