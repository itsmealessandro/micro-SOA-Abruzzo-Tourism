...
public class Weather {
    ...
    public boolean isSuitableForTrails() { return suitableForTrails; }
    public void setSuitableForTrails(boolean suitableForTrails) { this.suitableForTrails = suitableForTrails; }
