 ...
 * 
 */
@WebServiceClient(name = "WeatherServiceImplService", targetNamespace = "http://services.provider_weather.spring.rest/", wsdlLocation = "http://localhost:8082/soap-api/weather?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEATHERSERVICEIMPLSERVICE_QNAME = new QName("http://services.provider_weather.spring.rest/", "WeatherServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8082/soap-api/weather?wsdl");
    ...
    public WeatherService getWeatherServiceImplPort() {
        return super.getPort(new QName("http://services.provider_weather.spring.rest/", "WeatherServiceImplPort"), WeatherService.class);
    }
    ...
    public WeatherService getWeatherServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.provider_weather.spring.rest/", "WeatherServiceImplPort"), WeatherService.class, features);
    }
